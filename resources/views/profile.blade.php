            	...
            	<div class="row">
	       		...
	       		<div class="row">
		       		<div class="col-lg-5"></div>
		       			<div class="col-lg-4">
		            		<span class="image featured"><img src={{($userProfile==null || $userProfile->portrait=="")? URL::asset("images/blog19.jpg") : URL::asset($userProfile->portrait)}} height="200" width="180" alt="" /></span>
